...
<div class="">
  <div class='flex w-10/12 my-10 bg-white shadow-md rounded-lg overflow-hidden mx-auto'>
      <div class='flex items-center w-full'>
          <div class='w-full'>
              <div class="flex flex-row mt-2 px-2 py-3 mx-3">
                  <div class="w-auto h-auto rounded-full border-2 border-pink-500">
                      <img class='w-12 h-12 object-cover rounded-full shadow cursor-pointer' alt='User avatar' src='{{ asset('images').'/'.$post->thumbnail }}'>
                  </div>
              ...
              <div class='text-gray-400 font-medium text-sm mb-7 mt-6 mx-3 px-2 w-auto relative'><img class="rounded max-w-full h-auto" src="{{ asset('images').'/'.$post->thumbnail }}"></div>
              <div class='text-gray-600 font-semibold text-lg mb-2 mx-3 px-2'>
                {{ $post->title }}</div>
              <div class='text-gray-500 font-thin text-sm mb-6 mx-3 px-2 ck-content' id="desc">
                {!! $post->description !!}
            </div>
