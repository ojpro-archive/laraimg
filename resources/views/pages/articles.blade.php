                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <p class="text-gray-900 whitespace-no-wrap">
                                                {{ \Illuminate\Support\Str::limit($article->title, 60, $end='...') }}
                                            </p>
                                        </a>
                                        </div>
                                ...
                                <td class="py-3 px-6 text-center">
                                    ...
                                    <form action="{{ route('article.destroy', $article->id) }}" class="flex " method="post">
                                    @csrf
                                    @method('DELETE')
                                        <div class="transform hover:text-purple-500 hover:scale-110">
                                            
                                            <button type="submit" class="block cursor-pointer w-4 h-4" id="delete">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
