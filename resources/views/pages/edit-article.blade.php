...
<form action="{{ route('article.store') }}" method="post" enctype="multipart/form-data">
  ...
  <div class="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
    ...
    <input class="title bg-gray-100 border border-gray-300 p-2 mb-4 rounded-md outline-none" spellcheck="false" placeholder="Title" type="text" name="title" value="{{ $article->title }}">
    <div>
    ...
    <textarea name="description" class="description bg-gray-100 sec p-3 h-60 rounded-md border border-gray-300 outline-none" spellcheck="false" placeholder="Describe everything about this post here" id="description">{{ $article->description }}</textarea>
    <!-- component -->
